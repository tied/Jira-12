/**
 * Created by michaelsh on 5/27/2018.
 */
...
//def effectesversions = origJsonObject.fields.versions.name // array
    ...
    def status =  statushistory[statushistory.size()-1].toString()
...
String runApi(String url1, String userName, String userPass, String method, String body){
    ...
    try {
        ...
        HttpsURLConnection connection = (HttpsURLConnection)jiraURL.openConnection()
